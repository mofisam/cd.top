        ...
        <div class="sidebar w-64 fixed h-full overflow-y-auto bg-slate-900/95 backdrop-blur border-r border-blue-500/30">
            ...
            <nav class="p-4">
                <div class="space-y-2">
                    ...
                    <a href="activity.php" class="nav-item active flex items-center gap-3 px-4 py-3 rounded-lg text-gray-300 hover:text-white transition bg-blue-500/20">
        ...
        <div class="flex-1 ml-64 overflow-y-auto">
            <div class="p-8">
                <div class="mb-8">
                    ...
                    <p class="text-gray-400 mt-1">Complete history of admin actions</p>
                </div>
                    ...
                    <table class="w-full">
                        ...
                        <tbody>
                            ...
                            <tr class="border-b border-gray-700 hover:bg-slate-700/30">
                                <td class="p-4 font-semibold"><?php echo htmlspecialchars($row['username'] ?? 'System'); ?></td>
                                <td class="p-4">
                                    <span class="px-2 py-1 <?php 
                                        echo strpos($row['action'], 'LOGIN') !== false ? 'bg-green-500/20' : 
                                            (strpos($row['action'], 'DELETE') !== false ? 'bg-red-500/20' : 'bg-blue-500/20'); 
                                    ?> rounded-full text-xs">
                                        <?php echo htmlspecialchars($row['action']); ?>
                                    </span>
                                </td>
                                <td class="p-4"><?php echo htmlspecialchars($row['details'] ?? '—'); ?></td>
                                <td class="p-4"><?php echo date('M d, Y H:i:s', strtotime($row['created_at'])); ?></td>
